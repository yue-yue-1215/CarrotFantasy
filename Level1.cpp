...
bool Game_one::init()
{
    ...
    // 加入背景图片
    auto map_one = Sprite::create("Background_one.png");
  
    if (map_one == nullptr)
    {
        problemLoading("'Background_one.png'");
    }
    else
    {
...
// 萝卜血条更新
void Game_one::carrotHealthUpdate(float Dt)
{
...
// 在怪物出生点生成一只怪物
void Game_one::generateOneEnemy(vector<Enemy*>& EnemyExist, int enemyType, double x, double y)
{
